...
insert into content (courseID, section, title, description, slideURL, labURL) values ('pks-workshop-hackathon', 'pe', 'Interactive Lab', '', 'pe/PKS_interactive.pdf', '');

insert into content (courseID, section, title, description, slideURL, labURL) values ('pks-nginx-lab', 'pe', 'Nginx', '', '', 'pe/Nginx_Lab.pdf');
insert into content (courseID, section, title, description, slideURL, labURL) values ('pks-spark-lab', 'pe', 'Spark', '', '', 'pe/Spark_Lab.pdf');
insert into content (courseID, section, title, description, slideURL, labURL) values ('pks-elastic-lab', 'pe', 'Elasticsearch', '', '', 'pe/Elasticsearch_Lab.pdf');
insert into content (courseID, section, title, description, slideURL, labURL) values ('pks-suitecrm-lab', 'pe', 'SuiteCRM', '', '', 'pe/SuiteCRM_Lab.pdf');
insert into content (courseID, section, title, description, slideURL, labURL) values ('pks-wildfly-lab', 'pe', 'Wildfly', '', '', 'pe/Wildfly_Lab.pdf');
...
insert into content (courseID, section, title, description, slideURL, labURL) values ('pcfd-intro', 'pcfd', 'Pivotal Cloud Foundry - Introduction', '', 'pcf-developer/pcf-intro.pdf','');
insert into content (courseID, section, title, description, slideURL, labURL) values ('pcfd-microservices', 'pcfd', 'Microservices', '', 'pcf-developer/microservices.pdf','');
insert into content (courseID, section, title, description, slideURL, labURL) values ('pcfd-services', 'pcfd', 'Services', '', 'pcf-developer/services.pdf','');
insert into content (courseID, section, title, description, slideURL, labURL) values ('pcfa-buildpack', 'pcfa', 'Buildpack', '', 'pcf-admin/buildpack.pdf','');
insert into content (courseID, section, title, description, slideURL, labURL) values ('pcfa-bosh', 'pcfa', 'BOSH', '', 'pcf-admin/bosh.pdf','');
insert into content (courseID, section, title, description, slideURL, labURL) values ('pcfd-arch', 'pcfd', 'PCF Architecture', '', 'pcf-developer/pcf-arch.pdf','');
insert into content (courseID, section, title, description, slideURL, labURL) values ('pcfd-cd', 'pcfd', 'Continuous Delivery', '', 'pcf-developer/continuous-delivery.pdf','');
insert into content (courseID, section, title, description, slideURL, labURL) values ('pcfa-security', 'pcfa', 'Security', '', 'pcf-admin/security.pdf','');
insert into content (courseID, section, title, description, slideURL, labURL) values ('pcfa-ops', 'pcfa', 'Operation Fundamentals', '', 'pcf-admin/pcf-ops.pdf','');
insert into content (courseID, section, title, description, slideURL, labURL) values ('pcfd-developer', 'pcfd', 'PCF App Fundamentals', '', 'pcf-developer/pcf-developer.pdf','');
